                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text("The Title ", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                          ),
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text("Lorem Ipsum is simply dummy text of the printing and typesetting leap into re like Aldus PageMaker including versions of Lorem Ipsum.", style: TextStyle(fontSize: 12),),
                              ),
                            ],
                          ),
                          // SizedBox(height: 10,),
